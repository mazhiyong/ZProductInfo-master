...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private int titelTextTopDistance;// 记录底部商品标题距离顶部的高度
    ...
    private void initView() {
        ...
        myScrollView.setOnScrollListener(new MyScrollView.OnScrollListener() {
            ...
            public void onScrollchanged(int l, int scrollY, int oldl, int oldt) {
                vpagerTopDistance = bottomVPager.getTop() - classifyHeight - toolbarLayout.getHeight(); //63
                titelTextTopDistance = tvTitle.getTop() - - classifyHeight - toolbarLayout.getHeight(); //2536
                Log.i("show","scrollY:"+scrollY);
                ...
                if (scrollY >= toolbarLayout.getHeight() && scrollY < 200){
